...
\newcommand{\citeurlaux}[1]{%  
    ...
    % conditional superscript for occurrence number (we never show the first occurrence) 
    % TODO: to add 'a' we need future information
    % Only show superscript if the final count for this ID is > 1
    % \ifnum\csuse{occcount@\thisid}>1\textsuperscript{\numalph{\occnum}}\fi
    }%
    ,~% delimiter with small space
